...
if __name__ == "__main__":
    ...
    if test == 0:
        ...
        janus.set_model("deepseek-ai/Janus-Pro-1B")
        janus.set_processor("deepseek-ai/Janus-Pro-1B")
        tester.set_dataframe("/home/ubuntu/Tesis/Results/TestingJanusScore.csv")
    ...
    tester.set_numpy_array("/home/ubuntu/Tesis/Results/TestingJanusScore.npz")
    # tester.set_MLLM(llava)
