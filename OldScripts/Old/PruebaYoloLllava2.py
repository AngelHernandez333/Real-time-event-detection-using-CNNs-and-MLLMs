...
conversation = [
    {
        ...
        "content": [
            ...
            {
                "type": "text",
                "text": "Tell me if there is a person seen lying on the ground in the parking lot, surrounded by several parked cars in the video, just answer True or False",
            },
        ],
    },
]
conversation3 = [
    {
        ...
        "content": [
            ...
            {
                "type": "text",
                "text": "Check the video, has some boxes of color pink, so focus on that, and tell me if there is a person seen lying on the ground in the parking lot, surrounded by several parked cars in the video, just answer True or False",
            },
        ],
    },
]
conversation2 = [
    {
        ...
        "content": [
            {"type": "video"},
            {"type": "text", "text": "Tell me what is happening in the video"},
        ],
    },
]
