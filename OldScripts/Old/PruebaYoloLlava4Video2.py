...
@author: ubuntu
Add to the conversation the classes of yolov10
Add the possible classes of the videos
...
def detection(image):
    ...
    for r in results:
        ...
        for box in boxes:
            ...
            if detection_labels[class_label] == "person":
                classes["person"] = classes["person"] + 1
            cv2.putText(
                image,
                text,
                (x1, y1 - 10),
    ...
    conversation1 = [
        {
            ...
            "content": [
                ...
                {
                    "type": "text",
                    "text": f'There are {classes["person"]} persons in the video, there is a person lying on the ground? Just yes or no',
                },
            ],
        },
    ]
    conversation3 = [
        {
            ...
            "content": [
                ...
                {
                    "type": "text",
                    "text": f'There are {classes["person"]} persons in the video, there is an motocycle accident? Just yes or no',
                },
            ],
        },
    ]
...
# Video
cap = cv2.VideoCapture("../peru_1.mp4")
