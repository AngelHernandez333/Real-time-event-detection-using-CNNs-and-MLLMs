...
1-An class to do the prompt from the detections
"""
import cv2
...
def detection(image):
    ...
    for r in results:
        ...
        for box in boxes:
            ...
            if detection_labels[class_label] == "car":
                classes["car"] = classes["car"] + 1
            cv2.putText(
                image,
                text,
                (x1, y1 - 10),
    ...
    conversation3 = [
        {
            ...
            "content": [
                ...
                {
                    "type": "text",
                    "text": f'There are {classes["car"]} car in the video, there is an possible car accident? Just yes or no',
                },
            ],
        },
    ]
