...
"""df = pd.read_csv('/home/ubuntu/Tesis/Results/resultsBici_7v.csv')
df1 = pd.read_csv('/home/ubuntu/Tesis/Results/resultsFight_7v.csv')
df2 = pd.read_csv('/home/ubuntu/Tesis/Results/resultsPlay_7v.csv')
df3 = pd.read_csv('/home/ubuntu/Tesis/Results/resultsRun_7v.csv')
df4 = pd.read_csv('/home/ubuntu/Tesis/Results/resultsLying_7v.csv')
df = pd.concat([df, df1, df2, df3, df4], ignore_index=True)
df.to_csv('Results/results7v.csv', index=False)"""
# Count the occurrences of each type of event
df = pd.read_csv("/home/ubuntu/Tesis/Results/resultsQwen2VL_6dic.csv")
