...
axes[0].set_xticklabels(mAP_combined['Model'], rotation=0, color="black", fontweight="bold")
...
axes[1].set_xticklabels(mAP_combined['Model'], rotation=0, color="black", fontweight="bold")
